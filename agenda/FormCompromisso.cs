...
namespace agenda
{
    ...
    public partial class FormCompromisso : Form
    {
        ...
        private void textBoxConvidado_TextChanged(object sender, EventArgs e)
        {
        ...
        private void comboBoxTipoLembrete_SelectedIndexChanged(object sender, EventArgs e)
        {
        ...
        private void labelTerminarEm_Click(object sender, EventArgs e)
        {
